...
*/
    public static void main(String[] args) {
        ...
        // Classe ComparatorOrdemNumerica refatorada com classe anonima
        // Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(new Comparator<Map.Entry<Integer, Contato>>(){
            ...
            Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(Comparator.comparing(
                // Comparator.comparing permite fazer comparaçãop com functions interface
                ...
                // 
        // Classe ComparatorOrdemNumerica refatorada com funçao lambda
